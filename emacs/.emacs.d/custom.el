(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rust-mode atom-one-dark-theme olivetti olivetti-mode f volatile-highlights counsel swiper ace-window ivy undo-tree which-key diff-hl crux super-save flycheck imenu-anywhere hl-todo company yaml-mode inf-ruby pdf-tools markdown-mode elixir-mode cider clojure-mode auctex rainbow-mode rainbow-delimiters move-text exec-path-from-shell easy-kill anzu dired uniquify paredit expand-region pt projectile ag git-timemachine magit zenburn-theme use-package))))
(custom-set-faces
